...
public class AuthenticationRestService {
	...
	public ServiceLoginResponse authenticate(ServiceLoginRequest request, @Context HttpServletRequest httpRequest) throws InternalSystemException, 
		...
		SecretKey serviceKey = iAuthenticationAPI.callKeyServerForSecretKeyUtility();
		...
		Session session = sessionDirectory.findActiveAppSessionByAppID(appLoginName);
		if (session == null){
		...
		log.info("Returning from AuthenticationRestService.authenticate method");
