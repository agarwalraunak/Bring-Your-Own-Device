...
@Provider
public class UnauthorizedServiceTicketRequestExceptionMapper implements ExceptionMapper<UnauthorizedServiceTicketRequestException>{

	@Override
	public Response toResponse(UnauthorizedServiceTicketRequestException exception) {
